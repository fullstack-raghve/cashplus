...
@Component({
  selector: 'app-multicity-calendar',
  templateUrl: './multicity-calendar.component.html',
  styleUrls: ['./multicity-calendar.component.scss'],
})
export class MulticityCalendarComponent implements OnInit {
    dateValue: any;
    maxDate;
    departDate;
    returnDate;
    ...
    constructor(
      ...
      private _bottomSheetRef: MatBottomSheetRef<MulticityCalendarComponent>,
    ...
    // console.log(res);
     this.filghtData = res;
    // console.log(this.filghtData);
    });
    //get index -- of currnt
    this.globalService.getindex().subscribe((res)=>{
     if(res > 0)
     {
       if(this.filghtData[res -1].JourneyDate)
         this.minimumDate = this.filghtData[res -1].JourneyDate;
       else
    ...
    setStyleIfRecentSearchClick(){
      ...
      allDivs = hElement.getElementsByClassName('bgMultiCalederBGActive');
     // console.log(allDivs)
    ...
    rangeClass = document.getElementsByClassName('rangeCalender');
        ...
        setTimeout(() => {
          if (allDivs[0].classList.contains("bgMultiCalederBGActive")) {
    ...
    submit() {
      this._bottomSheetRef.dismiss({value:true});
          // for(let i=0;i<res;i++)
      // {
      //   if(this.filghtData[i].JourneyDate == "")
      //   {
      //     this.filghtData[i].JourneyDate 
      //   }
      // }
    ...
    setStyleCalender() {
     ...
     // console.log(allDivs)
      ...
      let rangeClass;
      rangeClass = document.getElementsByClassName('multiCityCalendar');
